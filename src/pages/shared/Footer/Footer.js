    ...
    return (
        <div>
            <footer className="px-4 divide-y bg-gray-700 text-gray-100">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3">
                        <Link to="#" className="flex justify-center space-x-3 lg:justify-start">
                            ...
                            <span className="self-center text-2xl font-semibold">ExPhotography</span>
                        </Link>
                    </div>
                ...
                <div className="py-6 text-sm text-center text-gray-400">© 2022 ExPhotography.Com All rights reserved.</div>
            </footer>
        </div>
    );
};
